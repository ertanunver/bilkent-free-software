...
do
	...
	do
		...
		url="https://stars.bilkent.edu.tr/homepage/ajax/plainOfferings.php?COURSE_CODE=${course[0]}&SEMESTER=20152&submit=List%20Selected%20Offerings&rndval=1457358879039"
		curl -s -o $file $url	
